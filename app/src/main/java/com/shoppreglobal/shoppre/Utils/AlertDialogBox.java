...
import com.shoppreglobal.shoppre.UI.CreateShipRequest.CreateShipmentDeliveryAddress;
...
public class AlertDialogBox {
    ...
    public void showAlertDialog(Context context, List<PackageModel> tempList, int inReviewCount
        ...
        dialog.setContentView(com.shoppreglobal.shoppre.R.layout.alert_dialog_box);
